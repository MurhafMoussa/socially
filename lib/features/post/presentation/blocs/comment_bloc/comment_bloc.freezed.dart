...
abstract class _GetComments implements CommentEvent {
  const factory _GetComments({required final int postId}) = _$GetCommentsImpl;
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<CommentModel> comments})
      : _comments = comments;
...
abstract class _Loaded implements CommentState {
  const factory _Loaded({required final List<CommentModel> comments}) =
      _$LoadedImpl;
